...
\graphicspath{{../common/latex/delta_header/}{../common/latex/equipment_table/}{../common/latex/signature_table/}{../common/latex/version_approval_table/}}
...
\begin{tabular}{|>{\centering\arraybackslash}m{0.9cm}
                ...
                |>{\centering\arraybackslash}m{3.5cm}
                |>{\centering\arraybackslash}m{3.5cm}
                |>{\centering\arraybackslash}m{3.5cm}|} % <- barra final añadida
\hline
...
\signatureTable{
Name of the person & Role of the person & DD/MM/YYYY &         \\ 
\hline
}
